...
import distance_measures.incomparable_pair as ip_dot
...
@app.route('/')
def home():
    return flask.render_template('visPage_somedraft.html')
...
@app.route('/api/incomparable_pair_recall')
def run_incomparable_pair_distance():
 
  return formatHandling("incomparable_pair")
